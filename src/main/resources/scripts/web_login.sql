...
create table user (id bigint not null auto_increment, account_non_expired bit, account_non_locked bit, created_date datetime, credentials_non_expired bit, enabled bit, last_modified_date datetime, password varchar(255), username varchar(255), admin_user_id bigint, guardian_user_id bigint, root_user_id bigint, teacher_user_id bigint, primary key (id)) engine=InnoDB;
